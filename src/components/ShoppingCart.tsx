          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="border-t pt-4 space-y-2">
                ...
                <p className="text-sm text-gray-500 text-right">Price Inclusive of VAT</p>
              </div>

              <div className="space-y-2 pt-4">
                <button className="w-full bg-stone-900 text-white py-3 rounded-md hover:bg-blue-700 transition-colors">
                  Finalizar Compra
                </button>
